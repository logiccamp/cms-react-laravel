                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="w-100 text-center btn bt-gradient bg-secondary" style="width: 100%" id="addServiceImageLabel" for="addServiceImage">Upload Image</label>
                                </div>
                                <div class="form-group">
                ...
                <div class="card-heading py-5">
                    <div class="row justify-content-between">
                        <div class="col-md-6 d-flex align-items-center">
                            <small class="p-0 mx-2 fw-bold">
                                <strong>
                                    Show Description on Home Page
                                </strong>
                            </small>
                            @if ($info->showServiceDescription_ServicePage)
                            <input type="checkbox" checked style="font-size: 18px;" class="form-check" name="showDescriptionHome" id="showDescriptionHome" />
                            @else
                            <input type="checkbox" style="font-size: 18px;" class="form-check" name="showDescriptionHome" id="showDescriptionHome" />
                            @endif
                        </div>
                        ...
                        <div class="col-md-6 d-flex align-items-center">
                            <small class="p-0 mx-2 fw-bold">
                                <strong>
                                    Show Description on Service Page
                                </strong>
                            </small>
                            @if ($info->showServiceDescription_Home)
                            <input type="checkbox" checked style="font-size: 18px;" class="form-check" name="showDescriptionHome" id="showDescriptionHome" />
                            @else
                            <input type="checkbox" style="font-size: 18px;" class="form-check" name="showDescriptionHome" id="showDescriptionHome" />
                            @endif
