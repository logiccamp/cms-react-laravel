...
<head>
    ...
    <meta name="description" content="Welcome to Top Class Carpets, furnishings and global designs limited ,your number one source for all kinds of wall to wall carpet , window blinds, artificial grass carpet , center rugs, Armstrong pvc carpet.">
        ...
        <div class="banner overlay" id="{{$page->page_name !== 'Home' ? 'page' : ''}}" style='background-repeat: no-repeat; background-position: center !important; background: url("{{env('APP_CDN')}}/{{$page->banner}}")'>
            <header class="px-lg-3">
                <nav class="navbar navbar-expand-lg navbar-dark bg-none py-3">
                    <a class="navbar-brand" href="#"><img style="max-width: 200px" class="img-fluid" src="{{env('APP_CDN')}}/{{$info->company_logo}}" alt=""></a>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="theme1_footerdiv wow fadeInUp" data-wow-delay="0.5s">
                                <a href="/"><img style="max-width: 200px" src="{{env('APP_CDN')}}/{{$info->company_logo}}" class="img-responsive" alt="herbal-pure-footer-logo"></a>
                                <p>{{$info->short_description}}</p>
                                <div class="theme1_social_icon">
                                    <ul>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <p>Copyright © {{date('Y')}} <a class="text-white" href="/admin">TopClass</a>, All Rights Reserved by <a target="_blank" href="//logiccamp.com.ng">Logic Software Solutions</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
