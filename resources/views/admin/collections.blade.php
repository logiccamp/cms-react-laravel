                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer d-flex justify-content-end align-items-center">
                                <div class="dnone" id="successBox" style="color: green; margin-right: 20px">New Collection Added</div>
    ...
    <div class="panel-body">
        <div class="col-md-12">
            <div class="d-flex justify-content-between">
                <div>
                    <h3 class="animated fadeInLeft">Collections </h3>
                    <p class="animated fadeInDown">
                        Home <span class="fa-angle-right fa"></span> Collections
                    </p>
                </div>
                <div>
                    <h3>
                        <a href="#?" class="btn btn-success" onclick="showAddService()">Add New</a>
                    </h3>
                </div>
